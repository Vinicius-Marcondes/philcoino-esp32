...
Firmware `0.3.3` emits at most eight enriched history samples per response,
...
The mutation target exports `LLVMFuzzerTestOneInput` for optional use with an
already-installed coverage-guided engine. No fuzzing dependency is required.
