...
inline constexpr std::array<ApiRouteDescriptor, 23> kApiRoutes{{
    ...
    {ApiRouteId::kPairingSessionStart, HttpMethod::kPost,
     "/api/v4/pairing/sessions", false},
    {ApiRouteId::kPairingSessionAction, HttpMethod::kPost,
     "/api/v4/pairing/sessions/*", false},
    {ApiRouteId::kState, HttpMethod::kGet, "/api/v4/state", true},
    {ApiRouteId::kSettings, HttpMethod::kPatch, "/api/v4/settings", true},
    {ApiRouteId::kMode, HttpMethod::kPut, "/api/v4/mode", true},
    {ApiRouteId::kHeaterPermission, HttpMethod::kPut,
     "/api/v4/heater-permission", true},
    {ApiRouteId::kDismissOverTemperature, HttpMethod::kPost,
     "/api/v4/faults/over-temperature/dismiss", true},
    {ApiRouteId::kTemperatureCalibrationStart, HttpMethod::kPost,
     "/api/v4/temperature-calibrations/*/current", true},
    ...
    {ApiRouteId::kTemperatureCalibrationRenew, HttpMethod::kPost,
     "/api/v4/temperature-calibrations/*/current/lease", true},
    {ApiRouteId::kScaleCalibrationStart, HttpMethod::kPost,
     "/api/v4/scale-calibrations/current", true},
