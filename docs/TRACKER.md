...
| [HIST-004](prds/PRD-007/tasks/HIST-004.md) | Agent | Done | Mobile 129 tests; typecheck; lint | Midpoint anchor; cursor after commit | Pending | None | None |
| [HIST-005](prds/PRD-007/tasks/HIST-005.md) | Agent | Done | 30 s window/gap/follow tests; localization | Stable clock windows and inspected-page offset | Pending | None | None |
