...
| [PERF-010](prds/PRD-013/tasks/PERF-010.md) | Agent | Done | Native/sanitizer 7/7; 32 captures; active-source/dependency audit | Removed disabled OLED/I2C surface; GPIO8/GPIO9 unassigned; API and fail-off startup preserved | Pending commit | ESP-IDF target toolchain unavailable, so image delta unavailable | Run pinned target build/size when toolchain is available |
