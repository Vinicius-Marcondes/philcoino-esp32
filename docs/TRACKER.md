...
| [PERF-011](prds/PRD-013/tasks/PERF-011.md) | Agent | Done | Production call graph; native/sanitizer 7/7; 32 captures | Removed five test-only storage-owning helpers; retained transactional API paths and active features | Pending commit | None | None |
